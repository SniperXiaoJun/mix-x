...
#ifndef MIX_PREFIX_CAPI_FUNC
#define MIX_PREFIX_CAPI_FUNC CAPI
#endif

#ifndef MIX_PREFIX_CAPI_TYPE
#define MIX_PREFIX_CAPI_TYPE CTYPE
#endif


#define __MIX_PREFIX_FUNC_PASTE(X,Y) __PASTE(X,Y)
#define __MIX_PREFIX_STR_PASTE(X,Y) X Y
#define __MIX_PREFIX_TYPE_PASTE(X,Y) __PASTE(X,Y)
