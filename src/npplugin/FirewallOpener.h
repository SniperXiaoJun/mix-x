...
#define EMULE_DEFAULTRULENAME_UDP_T ("eMule_UDP_Port")
#define EMULE_DEFAULTRULENAME_TCP_T ("eMule_TCP_Port")
...
public:
	...
	CICSRuleInfo(unsigned short nPortNumber, unsigned char byProtocol, CString strRuleName, bool bRemoveOnExit = false)
	{
...
public:
	...
	bool OpenPort(const unsigned short nPortNumber,const unsigned char byProtocol,const CString strRuleName, const bool bRemoveOnExit = false);
	...
	bool DoesRuleExist(const unsigned short nPortNumber,const unsigned char byProtocol);
